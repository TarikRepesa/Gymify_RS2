...
namespace Gymify.Services.Database
{
    ...
    new User { Id = 11, FirstName = "Haris", LastName = "Hasic", Username = "haris1", Email = "haris1@example.com", PhoneNumber = "061111121", DateOfBirth = new DateTime(2000, 6, 6), IsActive = true, IsUser = true, CreatedAt = new DateTime(2024,1,1), PasswordHash = userHash, PasswordSalt = userSalt },
