...
class ConfirmDialogs {
  ...
  static const Color _primaryBlue = Color(0xFF387EFF);
    ...
    final res = await _baseDialog<bool>(
      ...
      actions: [
        OutlinedButton(
          ...
          child: Text(noText, style: const TextStyle(fontWeight: FontWeight.w600)),
        ),
        const SizedBox(width: 12),
        ElevatedButton(
          onPressed: () => Navigator.of(context).pop(true),
          style: _filledBtn(bg: _primaryBlue),
          child: Text(yesText, style: const TextStyle(fontWeight: FontWeight.w600)),
        ),
      ],
    );
    ...
    await _baseDialog<void>(
      ...
      actions: [
        ElevatedButton(
          ...
          style: _filledBtn(bg: _primaryBlue),
          child: Text(okText, style: const TextStyle(fontWeight: FontWeight.w600)),
        ),
      ],
    );
  }
    ...
    final res = await _baseDialog<bool>(
      ...
      actions: [
        OutlinedButton(
          ...
          child: Text(badText, style: const TextStyle(fontWeight: FontWeight.w600)),
        ),
        const SizedBox(width: 12),
        ElevatedButton(
          onPressed: () => Navigator.of(context).pop(true),
          style: _filledBtn(bg: _primaryBlue),
          child: Text(goodText, style: const TextStyle(fontWeight: FontWeight.w600)),
        ),
      ],
    );
