...
using Gymify.EmailConsumer.DependencyInjection;
...
var smtpSettings = new SmtpSettings
{
    ...
    User = Environment.GetEnvironmentVariable("SMTP_USER") ?? "healthcaretest190@gmail.com",
    Password = Environment.GetEnvironmentVariable("SMTP_PASS") ?? "wqpidsqdgwzegtvt",
    FromEmail = Environment.GetEnvironmentVariable("FROM_EMAIL") ?? "Gymify@gmail.com",
    FromName = Environment.GetEnvironmentVariable("FROM_NAME") ?? "Gymify",
